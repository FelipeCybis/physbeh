...
from tracking_physmed.utils.utils import (
...
class Tracking(object):
    ...
    def plot_speed(self,
        ...
        (speed_array,
         time_array,
         index,
         speed_units) = self.get_speed(bodypart=bodypart,
                                       smooth=smooth,
        ...
        lc = LineCollection(lines, label=bodypart, linewidths=2, colors=self.colors[bodypart])
    ...
    def plot_position_2d(self,
        ...
        x_bp, _, index = self.get_position_x(bodypart=bodypart)
        y_bp = self.get_position_y(bodypart=bodypart)[0]
        if head_direction:
            index = self.Dataframe[self.scorer][head_direction_vector_labels[0]]['likelihood'].values > .8
        ...
        if head_direction == False:
            ...
            head_direction_array = self.get_direction_array(label0=head_direction_vector_labels[0],
