...
class Animate_plot2D:
    ...
    def update_frame(self):
        ...
        self.ax.collections[0]._paths += [mPath(line) for line in self.lines[self.current_frame:self.current_frame+self.frame_step]]
